  ...
  >
    <div class="chart-menu nav bg--gray-800">
      ...
      <ul class="__list mx--2@w">
          <li class="__item">
            <router-link class="__link" to="/careers" v-scroll-to="'#app_content'">Career outcomes</router-link>
          </li>
          <li class="__item">
          ...
          <li class="__item">
            <router-link class="__link" to="/graduate-school" v-scroll-to="'#app_content'">By graduate school</router-link>
          </li>
          <li class="__item">
