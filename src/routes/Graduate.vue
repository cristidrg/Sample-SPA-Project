...
<template>
  <section class="section">
    ...
    <div class="graduate-data pos--relative">
      ...
      <div class="graduate-data__schools-nav">
        ...
        <a v-if="schoolPageSize < schoolsSortedByName.length && (schoolIdx + 1) * schoolPageSize < schoolsSortedByName.length" v-on:click="schoolIdx += 1" class="graduate-data__schools btn --sm tc--gray-700">{{strings.next_button}}</a>
      </div>
    </div>
  </section>
</template>
